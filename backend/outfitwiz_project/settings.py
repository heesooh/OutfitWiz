...
"""
Django settings for outfitwiz_project project.
...
SECRET_KEY = 'django-insecure-(mwgyt2=p7!)rc4g^iu2g&8n(zs#+df*yg!*(fm%lzj_4)oci1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'outfitwiz_app', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'outfitwiz_project.wsgi.application'
